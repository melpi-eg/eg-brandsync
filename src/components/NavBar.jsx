...
const NavBar = () => {
  return (
    <nav className="h-[60px] bg-[#123845] flex items-center ">
      {/* logo */}
      <div
        className={`flex gap-3 items-center justify-center transition-all   w-fit`}
      >
        <svg
          id="Layer_1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="1.7403 3.1566 498.2597 113.8434"
          width="530px"
          height="110px"
        ...
        >
          ...
          <path
            ...
            style={{ fill: "white" }}
          />
          <text x="54" y="18" fill="#fff" style={{ fontSize: "20px" }}>
            BrandSync
          </text>
        </svg>
      </div>
